...
h55 = [Card(Card.NUM_5), Card(Card.NUM_5)]
A = [Card(Card.ACE)]
h66 = [Card(Card.NUM_6), Card(Card.NUM_6)]
...
h777 = [Card(Card.NUM_7), Card(Card.NUM_7), Card(Card.NUM_7)]
...
handlists = [h, h2, h23, h55, A, h66, AA, h67, AAAJ, AAA, AA64, AA3, A6, h8352,
             A45, K28, AK, h777, Q75, JQK5A]
